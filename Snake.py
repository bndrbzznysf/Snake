...
while running:
    ...
    window.fill("gray14")
    pygame.draw.rect(window, "grey10", (0, 0, window_width, menu_height))
...
#Windows : python3 -m PyInstaller --onefile --add-data=eat.mp3;. --add-data=game_over.mp3;. --add-data=Roboto-Light.ttf;. --icon=Waluigi.ico --noconsole Snake.py
#Linux : python3 -m PyInstaller --onefile --add-data=eat.mp3:. --add-data=game_over.mp3:. --add-data=Roboto-Light.ttf:. --noconsole Snake.py